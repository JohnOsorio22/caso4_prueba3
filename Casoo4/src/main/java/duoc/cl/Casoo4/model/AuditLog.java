...
public class AuditLog {
    ...
    @Schema(description = "Número de seguimiento del paquete afectado", example = "PKT-001")
    ...
    @Schema(description = "Estado previo al movimiento", example = "EN_RUTA")
    private String estadoAnterior;

    @Column(name = "estado_nuevo", length = 50)
    @Schema(description = "Nuevo estado tras el movimiento", example = "ENTREGANDO")
    ...
    @Column(length = 200)
    @Schema(description = "Observación adicional sobre el movimiento", example = "Paquete marcado como eliminado (soft delete)")
